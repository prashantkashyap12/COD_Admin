...
import { LiveDownloaderComponent } from './live-downloader/live-downloader.component';

import { PanelRootComponent } from './panel-root/panel-root.component';
const routes: Routes = [
  {path:'', redirectTo:'admin_live_user', pathMatch:'full'},
  ...
  {path:'admin_trans_money', component:PanelTransferMoneyComponent},
  {path:'admin_trans_money', component:PanelTransferMoneyComponent},
  {path:'LiveDownloader', component: LiveDownloaderComponent},
